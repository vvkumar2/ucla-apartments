            ...
            <div className="contact-reason">
                ...
                <div className="contact-check-boxes">
                    <div className="contact-check-boxes-left">
                        <FormControlLabel onChange={scheduleCheckBoxChange} control={<Checkbox />} label={<h1 className="check-box-text">Schedule a Tour</h1>} />
                        <FormControlLabel onChange={confirmCheckBoxChange} control={<Checkbox />} label={<h1 className="check-box-text">Confirm Availability</h1>} />
                    </div>
                    <div className="contact-check-boxes-right">
                        <FormControlLabel onChange={requestCheckBoxChange} control={<Checkbox />} label={<h1 className="check-box-text">Request Application</h1>} />
                        <FormControlLabel onChange={customCheckBoxChange} control={<Checkbox />} label={<h1 className="check-box-text">Custom Message</h1>} />
                    </div>
                </div>
            </div>
            { customCheckBox && <textarea className="contact-message" type="text" placeholder="Message" onChange={customMessageChange} /> }
