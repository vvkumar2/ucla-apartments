...
const Navbar = ({ color_scheme }) => {
    ...
    return (
        <div className={`fixed z-10 w-full top-0 left-0 px-site-standard-mobile sm:px-site-standard-medium lg:px-site-standard py-3 flex justify-between items-center duration-300 transition-all ${
