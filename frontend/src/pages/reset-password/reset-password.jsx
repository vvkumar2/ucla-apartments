            ...
            <div className="reset-container">
                <div className="reset-form-container">
                    ...
                    <div className="reset-form">
                        <input className="reset-password" type="password" placeholder="New Password" onChange={changePassword} value={password} />
                    ...
                    <button type="submit" className="submit-button-reset" onClick={ResetHandler}>
                        Reset
                    </button>
                    {error !== "" && <p style={{ marginTop: "5%", color: "#FF6961" }}>{error}</p>}
                    <h1 className="reset-to-login">
